...
//		}
//		if (!word.equals(randomString)&&!word.equals("A")) {
...
//		}
		...
		try {
			...
			ab = logs.checkAdminIdPassword(userId, pswd);
			if (mb != null && mb.getStatus()==0) {
				...
				errorMsgMap.put("LoginError", "該帳號不存在或密碼錯誤或是已被停權");
			}
			if (sb != null && sb.getStatus()==0) {
